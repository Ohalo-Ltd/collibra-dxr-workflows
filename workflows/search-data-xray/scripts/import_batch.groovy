// import_batch.groovy
//
// KEEP IN SYNC with workflows/rerun-data-xray-search/scripts/sync_files_batch.groovy
// — its twin for the rerun workflow (Collibra workflows can't share script files).
//
...
// guidance prescribes for high-volume workflows, so a 10k import never holds
